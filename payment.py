...
# credit: https://github.com/Blankerinodev/trc20_payment

# TRC20 лимит коммисии (ставить от 16, иначе транзакция может не пройти)
TRC20_FEE_LIMIT = 20000000 # Лимит 20 TRX

# USDT TRC20 Contract Address
USDT_CONTRACT_ADDRESS = 'TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t'

# API ключ от TronGrid
TRON_GRID_API_KEY = 'https://api.trongrid.io'
...
class TRCToken:
    ...
    def transfer_all_trc20(self, private_key, to_address):
